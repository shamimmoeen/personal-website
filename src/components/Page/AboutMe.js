			...
			<div className="lg:flex justify-start items-center xl:px-8">
				...
				<div className="lg:ml-8 text-center lg:text-left">
					<div className="text-lg leading-loose">
						<h3 className="text-2xl pb-2 font-medium">Who am I?</h3>
						<p className="pb-7">
						...
						<h3 className="text-2xl pb-2 font-medium">What am I doing?</h3>
						<p className="pb-7">
							I work full time as a WordPress Developer. In my free time, I study front-end development
							with React.
						</p>
						<h3 className="text-2xl pb-2 font-medium">How much experience do I have?</h3>
						<p className="pb-7">I started developing websites using WordPress in 2014.</p>
						<h3 className="text-2xl pb-2 font-medium">What is my goal?</h3>
